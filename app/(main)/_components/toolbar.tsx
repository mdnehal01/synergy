        ...
        <div className='group pl-[54px] relative'>
            {!!initialData.icon && !preview && (
                <div className='flex items-center group/icon pt-6 gap-x-2'>
                    ...
                    <Button onClick={() => {}} className='rounded-full opacity-0 group-hover/icon:opacity-100 transition text-neutral-800' variant="outline" size="icon">
            ...
            <div className='opacity-0 group-hover:opacity-100 flex items-center gap-x-1 py-4'>
                ...
                {!initialData.coverImage && !preview && (
                    <Button className='text-neutral-700' variant="outline" size="sm" onClick={() => {}}>
