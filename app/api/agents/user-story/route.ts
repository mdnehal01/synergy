...
export async function GET(req: Request) {
  const wiqlQuery = {
    query: 'SELECT [System.Id], [System.Title], [System.State], [System.AssignedTo], [System.WorkItemType], [System.CreatedDate], [System.ChangedDate] FROM workitems WHERE [System.AssignedTo] = "Md Nehal Akhlaque" ORDER BY [System.ChangedDate] DESC'
  };
